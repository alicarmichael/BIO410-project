...
#Next, we loaded in our fire data sets. These are three fires that occurred in the same area in 2020. Two of the fire lines merged and the other fire was really close to the borders of the merged fire. These three fires are often recorded as one large fire called the Santiam fire. We are using these because they were 3 very large fires in 2020 that have a lot of bee observations around them. 
