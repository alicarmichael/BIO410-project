...
#Checking how many NA Values we have in our Latitude and Longitude column. We won't be able to use rows with NA's so we need to drop them.
...
#removed blanks
final_oba_df <- oba[oba$Associated.plant...genus..species != "",]
...
observations and if we have any that seem like they might be incorrect. This is just an initial visualization to explore
