...
```{r}
oba_df <- oba_clean[, c("GenusSpecies", "Associated.plant", "Dec..Long.", "Dec..Lat.", "Collection.Date")]
...
oba_df_clean_sf <- st_as_sf(oba_df_clean, coords = c("Dec..Long.", "Dec..Lat."), crs = 4326)
...
ggplot() +
  ...
  geom_sf(data = BeachieCreek_sf, color = "purple", alpha = 0.9) +
  geom_sf(data = Riverside_sf, color = "yellow", alpha = 0.9) +
  geom_sf(data = oba_df_clean_sf, aes(color = "Blue"), size = 1, alpha = 0.9) +
  labs(
