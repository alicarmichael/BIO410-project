...
all_fires <- read.csv("project/data/fire_data_2000-2020.csv")
...
Fires <- read.csv("project/data/fire_data.csv")
head(Fires)
...
oba_observations_sf <- st_as_sf(oba, coords = c("Dec..Lat.", "Dec..Long."), crs = 4326)
...
Bee_Observations <- read.csv("project/data/observations-501373.csv")
Bee_Observations
